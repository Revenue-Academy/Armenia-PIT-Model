...
def initialize_vars(self):
    ...
    self.year_list = [2022, 2022, 2023, 2024, 2025, 2026, 2027]
    ...
    self.vars['pit_data_filename'] = "pit_sample_armenia_2022.csv"
    self.vars['pit_weights_filename'] = "pit_weights_armenia2022.csv"
